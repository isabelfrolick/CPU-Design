The images in the PDF contain primarily Verilog/VHDL Hardware Description Language (HDL) code and some diagrams/simulation outputs. The extracted ASCII text for the HDL code figures is provided below.

The "Verilog HDL Codes" section includes the text for Figures 1 through 12, as well as the figures relating to memory and control units (Figures 16, 17, 18, 19). For figures that appear to be diagrams or simulation results (like Figures 13-15 and 20-24), the accompanying text is provided.

### Verilog HDL Code (Figures 1 - 12)
...
### Descriptive Text for Figures 13 - 24 (Non-Verilog/VHDL Code Images)

**Figure 13: Input port register with strobe signal and inputs and outputs.**
Input Port

**Figure 14: Output port register with strobe signal and inputs and outputs.**
Output Port

**Figure 15: Select and Encode module for logic.**
Select and Encode Module

**Figure 16: Register VHDL code for Memory Access Register for Memory Module.**
Memory Access Register (MAR)

**Figure 17: Single I/O port for RAM.**
Single Port RAM

**Figure 18: QUARTUS generated VHDL code for RAM memory module**
Quartus Wizard Generated Memory Module

**Figure 19: VHDL module of control unit, to produce signals to datapath for ALU operation logic, using Method 1 in the lab system**
The VHDL module description. The actual code was not extracted as discrete text.

**Figure 20: The high-level entity module instantiating all register for the functional Datapath, including the memory submodule for register operations including Load, Store, Shift, etc.**
The high-level entity module description. The actual code was not extracted as discrete text.

**Figure 21: Testbench module including memory submodule and control unit addition operation.**
Testbench module description. The actual code was not extracted as discrete text.

**Figure 22: Output for the functional simulation in the control logic register, passing value from IR through control**
Output description for the functional simulation. The actual simulation output image data was not extracted as text.

**Figure 23: Instruction register functional output**
Instruction register functional output label. The actual simulation output image data was not extracted as text.

**Figure 24: Bus Encoder module output with inclusion of Control Register.**
Bus Encoder module output label. The actual simulation output image data was not extracted as text.
